...
def chatgpt_run(raw_data_str):
    ...
    ques_init_2 = [
        (raw_data_str, init_answer_strings[0], '입력된 payload의 경우, title로 시작하는 탐지할만한, Sigma Rule을 1개 만 in 3 sentences 작성해주세요.'),
    ...
    ques_init_3 = [
        (raw_data_str, init_answer_strings[0] + ' ' + second_answer_strings[0], '입력된 payload의 경우, alert로 시작하는 탐지할만한, Snort Rule을 1개 만 in 3 sentences 작성해주세요.'),
